            ...
            <?php foreach($userEntities as $userEntity):?>
                <li class="list-group-item">
                    ...
                    <?php if($userEntity->status == UserEntities::STATUS_WAIT):?>
                        &nbsp;<?= Html::a('<i class="glyphicon glyphicon-ok"></i>', ['/site/approve-gift', 'id'=>$userEntity->id], ['class'=>'btn btn-xs btn-success'])?>
                        &nbsp;<?= Html::a('<i class="glyphicon glyphicon-remove"></i>', ['/site/disapprove-gift', 'id'=>$userEntity->id], ['class'=>'btn btn-xs btn-danger'])?>
                    <?php endif?>
                </li>
            <?php endforeach?>
            </ul>
